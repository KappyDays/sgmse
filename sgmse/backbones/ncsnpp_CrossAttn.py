...
@BackboneRegistry.register("ncsnpp_crossattn")
class NCSNpp_CrossAttn(nn.Module):
    ...
    def __init__(self,
        ...
        **unused_kwargs
        ...
        self.output_layer = nn.Conv2d(4, 2, 1)
        ...
        AttnBlock = functools.partial(layerspp.CrossAttnBlockpp,
                                      init_scale=init_scale, skip_rescale=skip_rescale)
        ...
        for i_level in range(num_resolutions):
            ...
            for i_block in range(num_res_blocks):
                ...
                if all_resolutions[i_level] in attn_resolutions:
                    modules.append(AttnBlock(channels=in_ch//2))
                hs_c.append(in_ch)
